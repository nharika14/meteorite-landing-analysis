...
knit: (function(input, encoding) {
  ...
  file.copy("README.html", file.path("docs", "index.html"), overwrite = TRUE)

  if (dir.exists("README_files")) {
    unlink(file.path("docs", "README_files"), recursive = TRUE, force = TRUE)
    dir.create(file.path("docs", "README_files"), showWarnings = FALSE)
    file.copy(
      list.files("README_files", recursive = TRUE, full.names = TRUE),
      file.path("docs", "README_files"),
